...
Hurricane Katrina appeared to make [landfall on October 29, 2005 around 6 AM CDT](https://en.wikipedia.org/wiki/Timeline_of_Hurricane_Katrina#Second_and_Third_landfall). We will filter the data highlited above and plot the hurricane geom to visualize the wind speeds as it made landfall in Louisiana.
